...
* In the domain of social sciences and humanities, there is a significant positive terms are much less commonly used.
* With time, positive terms are being used more and more frequently.
* As in [BMJ 2019;367:l6573](https://www.bmj.com/content/367/bmj.l6573), *gender* appears to play a role in the use of positive terms in SNSF grant applications.  However, if we account for *domain* and *start year* of the grant, then the effect of *gender* appears to be much less significant.
